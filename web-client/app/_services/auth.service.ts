...
export class AuthenticationService {
  private _endPointUrl: string = "http://35.184.142.187:5984/_session";
  private _rootEndPointUrl: string = "http://admin:admin@35.184.142.187:5984/_users/org.couchdb.user:";
